...
Notebook: [`week07_uplift.ipynb`](week07_uplift.ipynb) · Reading: [`papers/`](papers/README.md)
...
_Paste the table from `registry.to_markdown(week=7)`. Then one sentence naming the
